...
\item \talk{Ka-Wai Chung (The Chinese University of Hong Kong)}{A phenomenological inclusion of ilternative dispersion relations to the Teukolsky equation and its application to bounding the graviton mass with gravitational-wave measurements}
...
mass $M \gg m$, the leading-order perturbations to the background spacetime
include an $\mathcal{O}[(m/M)^2]$ gravitational-radiation-reaction "self-force"
